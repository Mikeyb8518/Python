# Create a cahnge-counting game that gets the user to enter the numnber of coins required to make 
# exactly one dollar. The program should prompt the user to enter the number of pennies, nickels, dimes, and quarters.
# The program should congratulate the user for winning the game. Otherwise the program should display a message
...
dimes_value = number_of_dimes * one_dimes
# value of each quarters = userInput * 0.25
quarter_value = number_of_quarters * one_quarters

# now let calculate the total of one dollar
total = pennies_value + nickels_value +  dimes_value + quarter_value
